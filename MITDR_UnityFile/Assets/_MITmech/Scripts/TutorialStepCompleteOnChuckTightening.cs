...
public class TutorialStepCompleteOnChuckTightening : MonoBehaviour
{
    public CycleTextObject chuckTightening;
    public bool desiredIsTight;
    TutorialStep step;
    ...
    void Update()
    {
        if (chuckTightening.isTight == desiredIsTight)
        {
